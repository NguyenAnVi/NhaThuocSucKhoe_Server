...
<button class="uk-button uk-button-primary uk-padding-remove-vertical uk-padding-small" type="button"><span uk-icon="icon:cart"></span> @lang('general.cart')</button>
